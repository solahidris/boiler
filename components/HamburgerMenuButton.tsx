...
const HamburgerMenuButton = () => {
  ...
  const navigationLinkCSS = "flex flex-col gap-8 w-full h-full font-bold justify-end"
  ...
  return (
    <div>
      ...
      <div className={`${showMenu && mutedBackground}`}>
        {showMenu ?
            <div className={`w-[85vw] lg:w-[75vw] opacity-100 p-12 lg:p-20 ${navigationContainerCSS}`} onMouseLeave={()=>setShowMenu(false)}>
